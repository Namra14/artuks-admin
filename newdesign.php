    ...
    <section>
      ...
      <nav class="navigation">
        <ul class="nav justify-content-center">
          ...
          <li class="nav-item">
            <a class="nav-link active text-dark fw-bold" href="#">About</a>
          </li>
          <li class="nav-item">
              <a class="nav-link text-dark fw-bold active" href="newdesign.php">Jersey Design</a>
            </li>
            <li class="nav-item">
  ...
  <div class="row">
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<div class="newdesign-item">';
        echo '<img src="admin/' . $row['jersey_image'] . '" alt="' . $row['caption'] . '">';
        echo '</div>';
        echo '</div>';
      }
    } else {
