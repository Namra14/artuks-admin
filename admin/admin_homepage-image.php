<?php include 'config_homepage.php'; ?>
...
<body>
    ...
    <nav class="navigation">
          <ul class="nav justify-content-center">
            <li class="nav-item">
              <a class="nav-link text-dark text-dark fw-bold active" href="admin_homepage-image.php">Homepage-Image</a>
            </li>
            <li class="nav-item">
    ...
    <h2>Add New Image for Homepage Picture</h2>
    <form action="upload_homepage.php" method="post" enctype="multipart/form-data">
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='homepage-delete.php?id=" . $row['id'] . "'>Delete</a></td>";
                echo "</tr>";
            }
        }
        ?>
