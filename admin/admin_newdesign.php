...
<head>
    ...
    <title>Artuks Admin/New Design Page</title>
    <!--CSS-->
    ...
    <nav class="navigation">
      ...
      <!--Popup Message-->
       ...
       <div id="uploadSuccessMessage" class="alert alert-success text-center fw-bold" style="display: none;">
        ...
        <h2>Add New Image for New Jersey Deisgn</h2>
    <form action="upload_newdesign.php" method="post" enctype="multipart/form-data">
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row['id'] . "</td>";
                echo "<td><img src='" . $row['design_image'] . "' width='100'></td>";
                echo "<td>" . $row['caption'] . "</td>";
                echo "<td><a href='newdesign_delete.php?id=" . $row['id'] . "'>Delete</a></td>";
                echo "</tr>";
            }
        }
        ?>
