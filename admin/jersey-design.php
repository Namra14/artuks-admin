...
<head>
    ...
    <title>Artuks Admin/Jersey Design Page</title>
    <!--CSS-->
...
<body>
    ...
    <nav class="navigation">
          <ul class="nav justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark fw-bold" href="admin_newdesign.php">New Design</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-dark fw-bold active" href="jersey-design.php">Jersey Design</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-dark fw-bold" href="pricelist.html">Price List</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-dark fw-bold" href="gallery.html">Gallery</a>
              </li>
              <li class="nav-item">
      ...
      <!--Popup Message-->
       ...
       <div id="uploadSuccessMessage" class="alert alert-success text-center fw-bold" style="display: none;">
        ...
        <h2>Add New Image for Jersey Deisgn</h2>
    <form action="upload_jersey-design.php" method="post" enctype="multipart/form-data">
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row['id'] . "</td>";
                echo "<td><img src='" . $row['jersey_image'] . "' width='100'></td>";
                echo "<td>" . $row['caption'] . "</td>";
                echo "<td><a href='jersey-design_delete.php?id=" . $row['id'] . "'>Delete</a></td>";
                echo "</tr>";
            }
        }
        ?>
