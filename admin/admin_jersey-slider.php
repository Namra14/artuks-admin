...
<section>
    ...
    <!--NAVIGATION-->
      <nav class="navigation">
          <ul class="nav justify-content-center">
            ...
            <li class="nav-item">
              <a class="nav-link active text-dark fw-bold" href="admin_jersey-slider.php">Jersey-Slider</a>
            </li>
            <li class="nav-item">
    ...
    <h2>Add New Image</h2>
    <form action="upload_jersey-slider.php" method="post" enctype="multipart/form-data">
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='jersey-slider_delete.php?id=" . $row['id'] . "'>Delete</a></td>";
                echo "</tr>";
            }
        }
        ?>
